...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.phone.setText("Contact No.:"+list.get(position).getPhoneno());
        holder.name.setText(list.get(position).getName());
        holder.depart.setText("Department:"+list.get(position).getDepartment());
//        holder.desig.setText(list.get(position).getDesignation());
//        holder.setdat.setText(list.get(position).getTvdate());
        ...
        holder.update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("department", String.valueOf(list.get(position).getDepartment()));
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        TextView name, depart, phone,desig,setdat;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            depart = itemView.findViewById(R.id.address);
            name = itemView.findViewById(R.id.name);
//            name = itemView.findViewById(R.id.desig);
//            name = itemView.findViewById(R.id.setdat);
