...
public interface Daoclass {
    ...
    @Query("update user SET name= :name ,department =:department, phoneno =:phoneno where `key`= :key")
    void updateData(String name, String phoneno, String department, int key);
